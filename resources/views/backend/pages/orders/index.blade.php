			...
			@foreach($orders as $order)
			 ...
			 <td>
			 	...
			 	@if($order->is_seen_by_admin)
			 		<button type="submit" class="btn btn-success btn-sm">Seen</button>
			 	@else
			 		<button type="submit" class="btn btn-warning btn-sm">Unseen</button>
			 	@endif
			 	</p>
			 	<p>
			 	...
			 	@else
			 		<button type="submit" class="btn btn-warning btn-sm">Not Completed</button>
			 	@endif
			 	</p>
			 	<p>
			 	@if($order->is_paid)

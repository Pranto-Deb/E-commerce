	...
	<div class="card-body">
		...
		<table class="table table-hover table-striped">
			 ...
			 <td>
				...
				<div class="form-group">
          		<label for="title">Slider Title<small class="text-danger">(required)</small></label>
          		<input type="text" style="display: block" class="form-control" name="title" id="title" placeholder="Slider Title" value="{{ $slider->title }}" required>
          		</div>
          		<div class="form-group">
          		...
          		<div class="form-group">
          		<label for="button-text">Slider Button Text<small class="text-info">(optional)</small></label>
          		<input type="text" style="display: block" class="form-control" name="button_text" id="button_text" placeholder="Slider Button Text (if need)" value="{{ $slider->button_text }}">
          		</div>
          		<div class="form-group">
          		<label for="button-link">Slider Button Link<small class="text-info">(optional)</small></label>
          		<input type="url" style="display: block" class="form-control" name="button_link" id="button_link" placeholder="Slider Button link(if need)" value="{{ $slider->button_link }}">
          		</div>
          		<div class="form-group">
          		<label for="priority">Slider Priority<small class="text-info">(required)</small></label>
          		<input type="number" style="display: block" class="form-control" name="priority" id="priority" placeholder="Slider Priority; e.g: 10" value="10" required value="{{ $slider->priority }}">
          		</div>

...
Route::group(['prefix' => 'products'], function(){
	...
	//Category Routes
	//Route::get('/categories', 'Frontend\CategoriesController@index')->name('index');
...
Route::group(['prefix' => 'admin'], function(){
	...
	Route::post('/password/res', 'Auth\Admin\ForgotPasswordController@sendResetLinkEmail')->name('admin.password.email');
